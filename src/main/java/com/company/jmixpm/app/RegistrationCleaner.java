...
public class RegistrationCleaner implements Job {
    ...
    public RegistrationCleaner(DataManager dataManager, TimeSource timeSource, SystemAuthenticator systemAuthenticator) {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        String result = systemAuthenticator.withSystem(() -> deleteOldNotActivatedUsers());
        log.info("Scheduled result: " + result);
    }
}