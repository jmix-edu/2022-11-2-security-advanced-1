...
public class RegistrationService {
    ...
    public User loadUserByActivationToken(String token) {
        User user = dataManager.load(User.class)
                .query("select u from User u " +
                        "where u.needsActivation = true and u.activationToken = :token")
    ...
    public void activateUser(User user, String password) {
        ...
        RoleAssignmentEntity assignment1 = dataManager.create(RoleAssignmentEntity.class);
        ...
        RoleAssignmentEntity assignment2 = dataManager.create(RoleAssignmentEntity.class);
        ...
        dataManager.save(user, assignment1, assignment1);
    }
}